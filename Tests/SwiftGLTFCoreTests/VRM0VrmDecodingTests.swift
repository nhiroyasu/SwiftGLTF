...
final class VRM0VrmDecodingTests {
    ...
    func testVRM0VrmOptionalDataDecoding() throws {
        ...
        #expect(VRM0HumanoidBoneName.leftThumbProximal.vrmHumanoidBoneName == .leftThumbMetacarpal)
        #expect(VRM0HumanoidBoneName.leftThumbIntermediate.vrmHumanoidBoneName == .leftThumbProximal)
        #expect(VRM0HumanoidBoneName.leftThumbDistal.vrmHumanoidBoneName == .leftThumbDistal)
        #expect(VRM0HumanoidBoneName.rightThumbProximal.vrmHumanoidBoneName == .rightThumbMetacarpal)
        #expect(VRM0HumanoidBoneName.rightThumbIntermediate.vrmHumanoidBoneName == .rightThumbProximal)
        #expect(VRM0HumanoidBoneName.rightThumbDistal.vrmHumanoidBoneName == .rightThumbDistal)
        #expect(humanoid.nodeMap[.leftThumbProximal]?.value == 1)
